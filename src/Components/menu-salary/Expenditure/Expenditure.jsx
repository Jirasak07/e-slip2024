...
function Expenditure() {
          ...
          setExpenditure({
            ...
            rows: [
              ...data.map((i, key) => ({
                ...
                manage: (
                  <ModalEditExpenditure
                    selectType={DataTypeEmploy}
                    FetchExpenditure={FetchExpenditure}
  ...
  const AddExpenditure = (data) => {
    ...
    setTimeout(() => {
      ...
      axios.post(API + "/index/Insertexpenditure", expendituredata).then((res) => {
    ...
    <>
      ...
      >
        ...
        >
          <SimpleGrid>
            <TextInput
              label="ชื่อรายจ่ายใหม่"
              withAsterisk
              {...formAddExpeniture.getInputProps("expenditure_name")}
            />
            <Select
              searchable
              withAsterisk
