...
function ModalExpenditure({ year, month, citizent, type }) {
    ...
    const handleClick = (expenditure_id, payslip_total) => {
        ...
        const artwork = yourDataCheck.find(
            a => a.expenditure_id === expenditure_id
        );
                    ...
                    {DataCheck.map((value, index) => (
                        <>
                            <Grid>
                                ...
                                <Grid.Col span={4}>
                                    <Text size="xs">{value.expenditure_name}</Text>
                                </Grid.Col>
                                <Grid.Col span={4}>
                                    <Checkbox
                                        mt="xs"
                                ...
                                <Grid.Col span={4}>
                                    <TextInput key={value.expenditure_id} value={value.payslip_total} onChange={e => handleClick(value.expenditure_id, e.target.value)} />
                                </Grid.Col>
                            </Grid>
                            {/* <Divider my="xs" /> */}
