import { Blockquote, Button, Divider, Fieldset, Flex, Modal, Paper, Radio, ScrollArea, SimpleGrid, Text, TextInput } from "@mantine/core";
...
function FormAddKTB() {
  ...
  return (
    <>
      <Button color="var(--success)" leftSection={<IconPlus/>} onClick={open}>เพิ่มข้อมูลแบบฟอร์ม</Button>
      <Modal
      ...
      >
        ...
        >
          ...
          <Text c={"blue"} >หากกรอกและบันทึกข้อมูลนี้แล้ว ให้พิมพ์แบบฟอร์มนี้ แล้วเตรียมสำเนาหน้าสมุดบัญชี จากนั้นนำมาส่งที่งานการเงิน</Text>  
            </Blockquote>
          </ScrollArea>{" "}
